...
static const uint8_t PROGMEM
  ...
  Gcmd[] = {                        // Initialization commands for 7735B screens
    ...
    0xEC, 1,                        //  9: Set pumping color freq
      0x1b,
    ST77XX_COLMOD, 1+ST_CMD_DELAY,  // 10: Set color format
      0x55,                         //     16-bit color
      100,
    ST77XX_CASET, 4,                // 11: Set Column Address
      0x00,
      0x00,
      0x00,
      0x7f,
    ST77XX_RASET, 4,                // 12: Set Page Address
      0x00,
      0x00,
      0x00,
      0x9f,
    ST77XX_MADCTL, 1,               // 13: Set Scanning Direction
      0xc8,
    0xb7, 1,                        // 14: Set Source Output Direciton
      0x00,
    0xf2, 1,                        // 15: Enable Gamma bit
      0x00,
    ST7735_GMCTRP1,15+ST_CMD_DELAY, // 16: Gamma Adjustments (pos. polarity), 16 args + delay:
      0x28, 0x24, 0x22, 0x31,
      0x2b, 0x0e, 0x53, 0xa5,
      0x42, 0x16, 0x18, 0x12,
      0x1a, 0x14, 0x03,
      50,
    ST7735_GMCTRN1,15+ST_CMD_DELAY, // 17: Gamma Adjustments (neg. polarity), 16 args + delay:
      0x17, 0x1b, 0x1d, 0x0e,
      0x14, 0x11, 0x2c, 0xa5,
      0x3d, 0x09, 0x27, 0x2d,
      0x25, 0x2b, 0x3c, 
      50, 
    ST77XX_NORON  ,   ST_CMD_DELAY, // 18: Normal display on, no args, w/delay
      10,                           //     10 ms delay
    ST77XX_DISPON ,   ST_CMD_DELAY, // 19: Main screen turn on, no args, w/delay
